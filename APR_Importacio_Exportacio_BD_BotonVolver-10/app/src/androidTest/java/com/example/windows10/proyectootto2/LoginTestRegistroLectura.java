...
public class LoginTestRegistroLectura {

    @Rule
    public ActivityTestRule<Login> mActivityTestRule = new ActivityTestRule<>(Login.class);

    @Test
    public void loginTestRegistroLectura() {
                ...
                allOf(withId(R.id.numMedidor),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText5.perform(scrollTo(), replaceText("33333"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.txt_lectura), withText("30"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
